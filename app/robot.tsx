// icon:robot-happy-outline | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from "react";
import Svg, { Path } from "react-native-svg";

function IconRobotHappyOutline(props: React.SVGProps<SVGSVGElement>) {
  return (
    <Svg
      viewBox="0 0 24 24"
      fill="currentColor"
